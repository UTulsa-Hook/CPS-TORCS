...
void SimpleStrategy::setFuelAtRaceStart(tTrack* t, void **carParmHandle, tSituation *s, int index)
{
	...
	float fuel = GfParmGetNum(*carParmHandle, JGF_SECT_PRIV, JGF_ATT_FUELPERLAP, (char*) NULL, t->length*MAX_FUEL_PER_METER);
...
void SimpleStrategy2::setFuelAtRaceStart(tTrack* t, void **carParmHandle, tSituation *s, int index)
{
	...
	m_pittime = GfParmGetNum(*carParmHandle, JGF_SECT_PRIV, JGF_ATT_PITTIME, (char*) NULL, 25.0f);
	m_bestlap = GfParmGetNum(*carParmHandle, JGF_SECT_PRIV, JGF_ATT_BESTLAP, (char*) NULL, 87.0f);
	m_worstlap = GfParmGetNum(*carParmHandle, JGF_SECT_PRIV, JGF_ATT_WORSTLAP, (char*) NULL, 87.0f);
	float maxfuel = GfParmGetNum(*carParmHandle, SECT_CAR, PRM_TANK, (char*) NULL, 100.0f);
